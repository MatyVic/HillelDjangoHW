...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_service', models.CharField(max_length=200, verbose_name='Post Service')),
                ('post_service_branch', models.CharField(max_length=200, verbose_name='Post Service Branch')),
